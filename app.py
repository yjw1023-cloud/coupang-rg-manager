...
# v0.9.147: apply() creates local staging/audit tables only. Network requests are
...
# v0.9.69 warehouse inventory Excel export + physical stocktake adjustment upload.
inventory_stocktake_v0969 = _original_import_module("inventory_stocktake_v0969")
inventory_stocktake_v0969.apply(core)
...
globals()["pnl_month_default_v0915"] = pnl_month_default_v09115
